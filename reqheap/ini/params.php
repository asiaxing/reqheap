...
//CONSTANTS
define("PROJECT_URL", "http://localhost/reqheap/reqheap");  //should be changed to https
define("PROJECT_FOLDERNAME", "reqheap");  //installation folder name
define("PROJECT_LOCAL_PATH", "/");
define("SITE_NAME", "ReqHeap");
define("DEFAULT_EMAIL", "asiaxing@163.com");
