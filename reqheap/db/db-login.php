<?php
    ...
    if (!function_exists('dblogin_get_user_record')) {
    ...
    if (!function_exists('dblogin_user_validate')) {
    ...
    if (!function_exists('dblogin_get_cur_user_id')) {
    ...
    if (!function_exists('dblogin_get_cur_user_acount')) {
    ...
    if (!function_exists('dblogin_get_cur_user_name')) {
    ...
    if (!function_exists('dblogin_get_cur_user_email')) {
    ...
    if (!function_exists('dblogin_get_cur_user_rights')) {
