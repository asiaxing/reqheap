<table border="0" cellpadding="2" cellspacing="0" class="topMenu" width="100%">
    <tr>
        <td>
            ...
            &nbsp;<a href="index.php?inc=my_profile"><?=$lng[2][19]?></a>&nbsp;|
            &nbsp;<a href="index.php?inc=manage_projects"><?=$lng[2][20]?></a>&nbsp;|
            &nbsp;<a href="index.php?inc=manage_subprojects"><?=$lng[2][34]?></a>&nbsp;|
            &nbsp;<a href="index.php?inc=manage_releases"><?=$lng[2][22]?></a>&nbsp;|
            &nbsp;<a href="index.php?inc=manage_cases"><?=$lng[2][35]?></a>&nbsp;|
            
            &nbsp;<a href="index.php?inc=manage_stakeholders"><?=$lng[2][27]?></a>&nbsp;|
            &nbsp;<a href="index.php?inc=manage_glossary"><?=$lng[2][28]?></a>&nbsp;|
            &nbsp;<a href="index.php?inc=manage_components"><?=$lng[2][39]?></a>&nbsp;|
            &nbsp;<a href="index.php?inc=manage_users"><?=$lng[2][21]?></a>&nbsp;|
            &nbsp;<a href="index.php?inc=edit_requirement"><?=$lng[2][23]?></a>&nbsp;|
            &nbsp;<a href="index.php?inc=import"><?=$lng[2][37]?></a>&nbsp;|
            &nbsp;<a href="index.php?inc=manage_keywords"><?=$lng[2][36]?></a>&nbsp;|
